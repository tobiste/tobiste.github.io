...
Since these forces are at an angular relationship to the plate motion between two plate, the pole of rotation serves as an new reference system. Plate motion parameters are easy to determine and the new reference system also allows for testing and predicting stress fields. This is in particular useful in areas where stress and strain data are not available [@Stephan2025]. And the method can be applied for paleo-stress fields if the relative plate motion from plate reconstructions is known.
