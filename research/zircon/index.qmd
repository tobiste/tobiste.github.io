...
description: "Identifying the source end-members for shelf sedimentary rocks incorporated in orogens. This helps to constrain the paleogeography of Peri-Gondwana prior to the assemblage of Pangea."
format:
  html:
    toc: true
    toc-location: right
...
![Detrital zircon spectra of the sources for the sedimentary rocks of the Peri-Gondwanan shelf [@Stephan2019a, Figure 3].](../../pictures/Stephan2019_GM_03.png)
...
![Statistical analyzis and clustering [@Stephan2019a, Figure 5].](../../pictures/Stephan2019_GM_05.png)
...
![Spatial distribution of the pre-Variscan zircon provinces along the Variscan basement of Europe and North America [@Stephan2019a; Fig. 6].](../../pictures/Stephan2019_GM_06.PNG)
