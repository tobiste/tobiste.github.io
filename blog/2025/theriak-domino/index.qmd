...
3.  Type and execute `{bash, echo=FALSE} guzzler`: Specify if you want to label the plot: 0
    (means No)

4.  Type and execute `{bash, echo=FALSE} explot`
