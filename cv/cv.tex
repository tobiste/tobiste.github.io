...
\lhead{\color{gray}\textsf{\MakeUppercase{Curriulum vitae}}}
\chead{}
...
\begin{cv}{\textsf{Dr Tobias Stephan}}
    ...
    \begin{cvlist}{}
        \item[2024/09--2024/12] \textbf {Sessional lecturer} for \enquote{Structural Geology and Tectonics}\\
...
\begin{cvlist}{Graduate level:}
        \item[4] Perez, A., \enquote{Petrology and Geochemistry of the western
        ...
        \item[3] Nwakanma, M., \enquote{Alteration and mineral paragenesis of the Moss Lake gold deposit (Shebandowan Greenstone Belt, Superior Province, Northern Ontario, Canada)}\\
        Degree: Master of Science. 
        Started: 2023/04, \textit{Lakehead University, Thunder Bay, Canada}
    ...
    \begin{cvlist}{}
        \item[total times cited:] 256\footnote[1]{Web of Science} (352\footnote[2]{Google
            Scholar})
        \item[h-index:] 6\footnotemark[1] (7\footnotemark[2])
        \item[-] Stephan, T, and Enkelmann, E. (subm.): \enquote{All Aligned on the Western Front of North America? Analyzing the Stress Field in the Northern Cordillera}. submitted to \textit{Tectonics} in July 2024.
    ...
    \begin{cvlist}{}
        ...
        Society of America, Proceedings of the Geologists' Association, Basin Research,
        Lithosphere
