...
\usepackage{xcolor}
\definecolor{myred}{HTML}{B63679}
\definecolor{myblack}{HTML}{000004}
\definecolor{mylgray}{gray}{0.8}
\definecolor{mygray}{gray}{0.6}

\pagestyle{fancy}
\renewcommand{\headrulewidth}{0pt}
\lhead{\textcolor{mylgray}{\textsf{\MakeUppercase{Curriculum vit\ae}}}}
\chead{}
\rhead{\textcolor{mylgray}{\textsf{Tobias Stephan}}}
%\rhead{}
%\cfoot{\thepage/11}
\cfoot{\textcolor{mylgray}{\textsf{\thepage\ of \pageref{LastPage}}}}

\renewcommand{\thefootnote}{\fnsymbol{footnote}} 

\setkomafont{section}{\color{mygray}\Large\scshape\MakeLowercase}
\setkomafont{subsection}{\color{mygray}\large}
...
\begin{cv}{\textcolor{myred}{\textsf{Dr Tobias Stephan}}}
    \medskip
    ...
    \begin{cvlist}{}
        \item[since 2025/12]  \textbf{Assistant Professor}\\ \textit{Lakehead University,
            Department of Geology, Thunder Bay, ON, Canada}
        \item[2023/04--2025/11] \textbf{Postdoctoral associate}\\ \textit{Lakehead University,
            ...
            Northern Ontario, Canada} --- NSERC Alliance Grant\\ Advisors: Dr Noah J. Phillips, Dr Peter Hollings

        \item[2024/09--2025/12] \textbf {Lecturer}\\ \textit{Lakehead University, Department of
            Geology, Thunder Bay, ON, Canada}

        \item[2020/12--2022/11] \textbf{DFG Research Fellow}\\
    ...
    \begin{cvlist}{Graduate level:}
        \item[4] Tiitto, H. \enquote{Deformation processes in a mid-crustal strike-slip shear zone: Insights from the Archean Quetico Shear Zone, Superior Province, Canada}\\
        Degree: Master of Science. 
        Completed: 2026/08, \textit{Lakehead University, Thunder Bay}
        ...
        Degree: Master of Science.
        Completed: 2025/09, \textit{Lakehead University, Thunder Bay, Canada}
        ...
        Degree: Master of Science.
        Completed: 2024/12, \textit{Lakehead University, Thunder Bay, Canada}
    ...
    \begin{cvlist}{Undergraduate level:}
        \item[8] Miller, B. \enquote{Structural analysis of gold-bearing shear zones of the White River Gold Mine (ON)}\\
        Degree: Bachelor of Honours. Started: 2026/06, \textit{Lakehead University, Thunder Bay}
        ...
        \item[7] Tiitto, H. \enquote{Anatomy of an Archean terrane boundary:
            ...
            (Superior Province)}\\
        Degree: Bachelor of Honours. Completed: 2024/04, \textit{Lakehead University, Thunder
            Bay, Canada}
...
%\item[total times cited:] 267\footnote[1]{Web of Science} (362\footnote[2]{Google Scholar})
        ...
        %\item[-] \ul{Stephan, T.}, Pinto, T. F., and Enkelmann, E. (submitted): \enquote{Technical Note: Cluster Analysis of Inverse Thermochronology Models}. \textit{Geochronology}. Preprint doi:\href{https://egusphere.copernicus.org/preprints/2026/egusphere-2026-1279/}{10.5194/egusphere-2026-1279}
        \item[-] \ul{Stephan, T.}, Pinto, T. F., and Enkelmann, E. (submitted): \enquote{Cluster Analysis of Inverse Thermochronology Models. Part 1: Statistical Method and Implementation }. \textit{Geosphere}
        
        \item[-] Pinto, T. F., \ul{Stephan, T.}, and Enkelmann, E. (submitted): \enquote{Cluster analysis of Inverse Thermochronology Models. Part 2: Geological Applications}.  \textit{Geosphere}

        \item[17] Pinto, T. F., Enkelmann, E., \ul{Stephan, T.}, Beranek, L., Padgett, J., Terlaky, V., and Qadri, T. (accepted): \enquote{Long-term effect of inherited basement structures on the basin evolution of northwestern Canada}. \textit{GSA Bulletin}

        \item[16] \ul{Stephan, T.}, Phillips, N., Tiitto, H., Perez, A., Nwakanma, M., and Hollings, P. (2025): \enquote{Going with the flow --- Changes of  Vorticity Controls Gold Enrichment in Archean Shear Zones (Shebandowan Greenstone Belt, Superior Province, Canada)}. \textit{Journal of Structural Geology} 201. \doi{10.1016/j.jsg.2025.105542}.

        \item[15] \ul{Stephan, T.}, and Enkelmann, E. (2025): \enquote{All Aligned on the Western Front of North America? Analyzing the Stress Field in the Northern Cordillera}. \textit{Tectonics} 44(9). \doi{10.1029/2025TC009014}.

        \item[14] Padgett, J., Enkelmann, E., Kellett, D., Moynihan, D., and \ul{Stephan, T.} (2025): \enquote{Cenozoic faulting in the Upper Hyland River Valley, Southeastern Yukon: A thermochronological perspective}. \textit{Canadian Journal of Earth Sciences} 62(5): 1002-1022. \doi{10.1139/cjes-2024-0147}.

        \item[13] Schaeben, H., Kroner, U., and \ul{Stephan, T.} (2024): \enquote{Mathematical Fundamentals of Spherical Kinematics of Plate Tectonics in Terms of Quaternions}. \textit{Mathematical Models and Methods in Applied Sciences} 47(6): 4469--4496. \doi{10.1002/mma.9823}
        ...
        %
        \item[4] \ul{Stephan, T.}, Kroner, U., Romer, R.\,L., and R\"osel, D. (2019): \enquote{From a bipartite Gondwana shelf to the arcuate Variscan belt: The Early Paleozoic evolution of northern Peri-Gondwana}. \textit{Earth-Science Reviews} 192: 491--512. \doi{10.1016/j.earscirev.2019.03.012}
        %
        \item[3] Heinicke, J., \ul{Stephan, T.}, Alexandrakis, C., Buske, S., and Gaupp, R. (2019): \enquote{Alteration as possible cause for transition from brittle failure to aseismic slip: the case of the NW-Bohemia\,/\, Vogtland earthquake swarm region}. \textit{Journal of Geodynamics} 124: 79--92. \doi{10.1016/j.jog.2019.01.010}
        %
        ...
        %
        \item[1] \ul{Stephan, T.}, Kroner, U., Hahn, T., Hallas, P., and Heuse, T. (2016): \enquote{Fold\,/\,cleavage relationships as indicator for late Variscan sinistral transpression at the Rheno\-/Hercynian\--Saxo\-/Thuringian boundary zone, Central European Variscides}. \textit{Tectonophysics} 681: 250--262. \doi{10.1016/j.tecto.2016.03.005}
    \end{cvlist}
    \endgroup
    ...
    \begin{cvlist}{} %\footnotetext{\textsf{only first authored contributions listed}}
        \item[47] Stephan, T. and Angombe, M. (2026): \enquote{structr} --- a statistical toolset for modern structural geology. \textit{GAC-MAC 2026}, St. John's, NF
        \item[46] Enkelmann, E., MacLeod, D., and Stephan, T. (2026): Cenozoic Exhumation and Fault Reactivation in the southern Canadian Cordillera. \textit{GAC-MAC 2026}, St. John's, NF
        \item[45] Tiitto, H., Phillips, N., and Stephan, T. (2026): Deformation processes in a mid-crustal strike-slip shear zone: Insights from the Archean Quetico Shear Zone, Superior Province, Canada. \textit{72\textsuperscript{nd} Annual Institute on Lake Superior Geology}, Thunder Bay, ON
        \item[43] Angombe, M., Phillips, N. J., Hollings, P., Stephan, T., Sheshnev, V., Deller, M., and Smith, A. (2026): Decoding Shear Zone Evolution in the McFaulds Greenstone Belt, Ontario: Constraints on Crystal-Plastic Deformation and Timing from in-situ Titanite U-Pb Thermochronology. \textit{72\textsuperscript{nd} Annual Institute on Lake Superior Geology}, Thunder Bay, ON
        \item[43] Stephan, T., Phillips, N. J., and Hollings, P. N. (2026): Timing and conditions of magmatism, metamorphism, and strain partitioning in the western Shebandowan Greenstone Belt (Superior Province). \textit{72\textsuperscript{nd} Annual Institute on Lake Superior Geology}, Thunder Bay, ON
    ...
    \begin{cvlist}{}
        ...
        Package website: \url{https://tobiste.github.io/structr/}
        \item[\texttt{geoprofiler}] Creates Swath profiles and Distance vs X plots by measuring the accurate distances parallel and perpendicular to user-defined lines (\doi{10.32614/CRAN.package.geoprofiler}).\\
        Package website: \url{https://tobiste.github.io/geoprofiler/}
        %\item[\texttt{ptrotR}] Free and open-source R package for plate motion reconstruction.\\
        %\url{https://github.com/tobiste/ptrotR}
        \item[\texttt{laftr}] Free and open-source R package to calculate the ages from LA-ICP-MS based fission track dating using the zeta approach. Package website: \url{https://tobiste.github.io/laftr/}
        ...
        \item[\texttt{thermoclustr}] Clustering, advanced statistics and densities of thermochronology cooling paths from inverse models: \url{https://github.com/tobiste/thermoclustr/}
        \item[\texttt{geocreep}] Estimate uncertainties in strain rates from flow laws, grain-size piezometry, and fugacity computations: \url{https://github.com/tobiste/geocreep/}
    \end{cvlist}

    %\newpage
    \section{Funding and Grants}
    \begin{cvlist}{}
        \item[2026--2031] NSERC Discovery Grant (CA\$\,183,000) --- \textit{Natural Sciences and Engineering Research Council of Canada}
        \item[2020--2022]
        \href{https://gepris.dfg.de/gepris/projekt/439621066?language=en}{DFG Research
            Fellowship} (\texteuro\,85,000) --- \textit{German Research Foundation (DFG)}
        ...
        %\item 2009 IAESTE Internship stipend --- \textit{International Association for the Exchange of Students for Technical Experience   (IAESTE)}
    \end{cvlist}

    \section{Awards}
    \begin{cvlist}{}
        \item[2026] CTG David Elliott Best Paper Award (2026) for \textit{\enquote{All Aligned on the Western Front of North America? Analyzing the Stress Field in the Northern Cordillera}} (Tectonics, 2025)
        \item[2014] Poster award at \textit{CETEG2015}, Kada\v{n}, Czech Republic, 2014
    \end{cvlist}
    ...
    \begin{cvlist}{}
        ...
        Society of America, Scientific Reports, GSA Bulletin, Proceedings of the Geologists'
        ...
        \item[Committee board member] Secretary of the Canadian
        Tectonics Group (GAC subdivision) since 2026
