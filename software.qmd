...
+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------+
| ### tectonicr {#sec-tectonicr}                                                                                                                                                            | ![](images/clipboard-1086098341.png){width="1.6in"} |
|                                                                                                                                                                                           |                                                     |
...
Calculates the ages from LA-ICP-MS based fission track dating: [Documentation](https://tobiste.github.io/laftr/) \| [Code](https://github.com/tobiste/laftr)
